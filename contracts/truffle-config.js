...
const infuraUrl = "https://mainnet.infura.io/79992fcf4e804b41b91a757b0032875879992fcf4e804b41b91a757b00328758"
const globalNode = "https://services.totlesystem.com/mainnet"
const quikNode = "https://virtually-engaging-javelin.quiknode.io/521d5672-27c6-43fe-9d8b-a506f90f33b3/s1p5o2fgroiXF8Fq1j5uLA==/"
const fs = require('fs'); const mnemonic = fs.readFileSync(".secret").toString().trim();

const gasLimitToUse = 5000000
const gasPriceToUse = 5000000000
const deployingAddress = "0xEC3281124d4c2FCA8A88e3076C1E7749CfEcb7F2"
